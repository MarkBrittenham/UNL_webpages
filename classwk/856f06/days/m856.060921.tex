...
The fact tht $Xf$ is a smooth function for smooth $f$ and smooth vector field $X$ means that
...
{\bf Vector bundles:} The tangent bundle will not be the only `bundle' over a smooth manifold
$M$ that we will find ourselves interested in. There will be many other linear spaces that we
will wish to assign to each point $a\in M$, and assemble into a bundle.
