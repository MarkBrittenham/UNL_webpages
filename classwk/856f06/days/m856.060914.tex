...
Given a smooth map $F:M^n\rightarrow N^m$ and $a\in M$, we can `push forward' a derivation $X$ at $a$ 
to a 
...
$i_*:T_aU\rightarrow T_aM$ ; any smooth function $f$ on $U$ can be thought of as one on
$M$ (via a bump function $g$), *************
