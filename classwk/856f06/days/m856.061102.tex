...
So far we haven't really talked about the usefulness of immersions, just submersions. 
...
A subset $S\subseteq M$ of a smooth manifold $M$ is called an {\it embedded submanifold
...
is called a $k$-slice of $U$, and $h$ is a slice chart for $S$ in $M$. 
