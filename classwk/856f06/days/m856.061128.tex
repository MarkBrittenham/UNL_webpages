...
One of the main results on the integral is Stokes' Theorem,
...
$D(dx^I)=0$. But $dx^I=dx^{i_1}\wedge\cdot\wedge dx^{i_k}$ for some set of indices, which (since each $x^{i_j}$ is `just'
...
definition is independent of the extensions chosen. We will not pursue this.
