...
So if $0<N<\sqrt{n}$, then $x^2-ny^2=N$ $\Rightarrow$ $\dsl |\sqrt{n} - {{x}\over{y}}| < {{1}\over{2y^2}}$
...
= $\dsl {{h_nk_ns_0^2t-(h_nr_0+h_{n-1})(k_nr_0+h_{n-1})}\over{k_n^2s_0^2t-(k_nr_0+h_{n-1})^2}}
