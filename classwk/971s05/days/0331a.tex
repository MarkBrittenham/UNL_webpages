...
While we are in the neighborhood, we may as well deal with the other main piece of homological algebra
that we will find useful ; the Five Lemma. Now that we have a way of building long exact sequences, we 
will soon have ways of building maps between them. So the next result becomes useful.

\msk

If we have abelian groups and maps
...
and the maps $\alpha,\beta,\delta,\epsilon$ are all isomorphisms, then $\gamma$ is an isomorphism.
